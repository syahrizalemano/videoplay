...
async def notforu(_, m: Message):
    k = await m.reply_sticker("CAACAgUAAxkBAAIoVmE7GMirK6jRDMifUAi61umlov5wAAIyAgAC44NpVVu0v29-goFTHgQ")
    await sleep(5)
    await k.delete()
    try:
        await m.delete()
...
async def not_chat(_, m: Message):
    buttons = [
            [
                InlineKeyboardButton("CHANNEL", url="https://t.me/videoplayn"),
                InlineKeyboardButton("SUPPORT", url="https://t.me/videoplayn"),
            ],
            [
                InlineKeyboardButton("🤖 MANAGE BY 🤖", url="ANO"),
            ]
         ]
    await m.reply_text(text="**Sorry, You Can't Use This Bot In This Group ! But You Can Make Your Own Bot**", reply_markup=InlineKeyboardMarkup(buttons), disable_web_page_preview=True)
